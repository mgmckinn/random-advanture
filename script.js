...
const adventureData = {
    "Outdoors": [
        {
            ...
            description: "Explore the beautiful local parks with walking trails, playgrounds, and picnic areas. Perfect for families to enjoy nature and get some fresh air!",
            address: "Main Street Park, {location}",
            website: "https://www.nps.gov"
        },
        {
            name: "Nature Trail Hike",
            description: "Discover local wildlife and beautiful scenery on family-friendly hiking trails. Bring your camera to capture amazing nature photos!",
            address: "Nature Trail Head, {location}",
            website: "https://www.trails.com"
        },
        {
            name: "Community Garden Visit",
            description: "Learn about plants and gardening while exploring beautiful community gardens. Many gardens offer workshops and seasonal activities!",
    ...
    "Creative": [
        {
            ...
            description: "Discover amazing artwork and participate in hands-on art activities designed for families. Many museums offer special kids' programs!",
            address: "Art Museum, {location}",
            website: "https://www.artmuseum.org"
        },
        {
            name: "Community Arts Center",
            description: "Join pottery classes, painting workshops, or craft sessions at your local arts center. Perfect for unleashing creativity together!",
            address: "Community Arts Center, {location}",
            website: "https://www.artscenter.org"
        },
        {
            name: "Local Library Creative Time",
            description: "Participate in storytelling, craft sessions, and creative workshops at your local library. Libraries often have amazing free programs for families!",
    ...
    "Learning": [
        {
            ...
            description: "Experience hands-on science exhibits and interactive displays that make learning fun for the whole family. Perfect for curious minds!",
            address: "Science Museum, {location}",
            website: "https://www.sciencemuseum.org"
        },
        {
            name: "Historical Society Tour",
            description: "Learn about local history through guided tours, historical artifacts, and interactive exhibits. Discover the fascinating stories of your community!",
            address: "Historical Society, {location}",
            website: "https://www.historicalsociety.org"
        },
        {
            name: "Planetarium Show",
            description: "Explore the wonders of space through immersive planetarium shows and astronomy programs. Learn about stars, planets, and the universe!",
    ...
    "Active": [
        {
            name: "Family Bowling",
            description: "Enjoy strikes and spares at your local bowling alley with family-friendly lanes, bumpers for kids, and fun arcade games!",
            address: "Bowling Center, {location}",
            website: "https://www.bowlingcenter.com"
        },
        {
            name: "Community Recreation Center",
            description: "Stay active with swimming, basketball, or fitness classes at your local recreation center. Many centers offer family swim times and activities!",
            address: "Recreation Center, {location}",
            website: "https://www.recreationcenter.org"
        },
        {
            name: "Mini Golf Adventure",
            description: "Challenge the family to a fun round of mini golf with creative obstacles and themes. Perfect for all ages and skill levels!",
    ...
    "Foodie": [
        {
            ...
            description: "Explore fresh local produce, artisanal foods, and family-friendly vendors at your community farmers market. Perfect for food discovery!",
            address: "Farmers Market, {location}",
            website: "https://www.farmersmarket.org"
        },
        {
            name: "Family Cooking Class",
            description: "Learn to prepare delicious meals together in a fun, family-oriented cooking class. Create memories while learning new recipes!",
            address: "Culinary School, {location}",
            website: "https://www.cookingschool.com"
        },
        {
            name: "Local Ice Cream Shop",
            description: "Treat the family to delicious homemade ice cream with unique flavors and fun toppings. Perfect for a sweet family outing!",
...
adventureForm.addEventListener('submit', async function (event) {
    ...
    try {
        ...
        const adventure = generateLocalAdventure(location, selectedTime, selectedInterests);
        ...
        displayError("Oops! We couldn't find an adventure right now. Please check your location or try different options!");
    } finally {
        // Hide loading state
        setLoading(false);
    }
...
function displayAdventure(adventure) {
    ...
    modalContentEl.innerHTML = `
        <div class="text-center">
            <img src="${imageUrl}" class="img-fluid mb-4" alt="${adventure.name}" onerror="this.onerror=null;this.src='https://placehold.co/800x400/ffb74d/ffffff?text=Adventure+Awaits!';">
            <p class="lead fs-5">${adventure.description || "A fantastic place to explore!"}</p>
            <hr>
            <p><strong>📍 Address:</strong> ${adventure.address || "Not available"}</p>
            ${adventure.website ? `<a href="${adventure.website}" target="_blank" class="btn btn-info">Visit Website</a>` : ''}
        </div>
    `;

    const adventureModal = new bootstrap.Modal(document.getElementById('adventureModal'));
    adventureModal.show();
}
